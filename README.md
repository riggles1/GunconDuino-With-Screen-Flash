...
* Before flashing: Give the Arduino a unique name ID, go to `C:\Program Files (x86)\Arduino\hardware\arduino\avr\boards.txt` and edit the `leonardo.name=` and `leonardo.build.usb_product=` lines with whatever name you want (this line is used for Pro Micro as well). 
