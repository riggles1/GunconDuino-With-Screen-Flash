...
(mirrorsed so that you can do the trigger+A+B combo through the controller to exit the arcade mode in Point Blank, as this combo otherwise disables the guncon)
